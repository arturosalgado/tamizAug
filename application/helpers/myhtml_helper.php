...
class Img extends Elem
{
    ...
    public $dimX='';
    public $dimY='';
    function __construct($src=null,$id=NULL, $class = Null)
    {
        ...
        parent::__construct($content='',$id,$class);
               // echo "***";
                $this->openTagO='<img style="border:none" src="'.$src.'" id="'.$id.'"  class="'.$class.'"';
...
class Img2 extends Elem
{
    ...
    function __construct($src=null,$id=NULL, $class = Null)
    {
        ...
        parent::__construct($content='',$id,$class);
               // echo "***";
                $this->openTagO='<img src="'.$src.'" id="'.$id.'"  class="'.$class.'"';
