...
<html lang="en-us">
	<head>
		...
		<title> Tamiz Prototype - Sintesys </title>
	...
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> 
                                    ...
                                    <a href="<?php echo base_url("/") ?>">    <img src="<?php echo base_url() ?>/themes/admin/img/logo.png" alt="SmartAdmin"> 
                                        </a>
			...
			<div class="pull-right">
				...
				<form action="#search.html" class="header-search pull-right">
					<input type="text" placeholder="Buscar" id="search-fld">
					<button type="submit">
		...
		<aside id="left-panel">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
					...
					<a href="javascript:void(0);" id="show-shortcut">
                                            <img src="<?php echo base_url("themes/admin/") ?>/img/avatars/sunny.png" alt="me" class="online" > 
						<span>
							Usuario 
						</span>
			...
			<nav>
				...
				<ul>
					<li class="active">
						<a href="index.html" title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Tablero</span></a>
					</li>
					...
					<li>
						...
						<ul>
							<li>
                                                            <a href="<?php echo site_url("/tamiz") ?>">Todos</a>
							</li>
							<li>
								<a href="<?php echo site_url("/tamiz/form/") ?>">Nuevo Registo</a>
							</li>
						</ul>
					</li>
					<li>
		...
		<!-- Demo purpose only -->
		<script src="<?php echo base_url('themes/admin') ?>/js/demo.js"></script>
		...
		<script src="<?php echo base_url('themes/admin') ?>/js/plugin/flot/jquery.flot.cust.js"></script>
		<script src="<?php echo base_url('themes/admin') ?>/js/plugin/flot/jquery.flot.resize.js"></script>
		<script src="<?php echo base_url('themes/admin') ?>/js/plugin/flot/jquery.flot.tooltip.js"></script>
		
		<!-- Vector Maps Plugin: Vectormap engine, Vectormap language -->
		<script src="<?php echo base_url('themes/admin') ?>/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js"></script>
		<script src="<?php echo base_url('themes/admin') ?>/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js"></script>
