...
<html lang="en-us">
	...
	<body id="login" class="animated fadeInDown">
		...
		<script src="<?php echo $theme ?>/js/plugin/pace/pace.min.js"></script>

	    <!-- Link to Google CDN's jQuery + jQueryUI; fall back to local -->
	    <script src="//ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script>
		<script> if (!window.jQuery) { document.write('<script src="<?php echo $theme ?>/js/libs/jquery-2.0.2.min.js"><\/script>');} </script>
		...
		<script src="<?php echo $theme ?>/js/plugin/fastclick/fastclick.js"></script>
		...
		<!-- MAIN APP JS FILE -->
		<script src="<?php echo $theme ?>/js/app.js"></script>
