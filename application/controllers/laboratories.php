...
class laboratories extends MY_Controller{
    ...
    private $Model = 'LaboratoryModel';
    protected $ViewPath = 'laboratories/';
      ...
      // print_r($record);
       ...
       {    
          ...
          //  $t->join
           ...
           return  $this->load->view("{$this->theme}/{$this->ViewPath}/list_view",  $this->data,true);  
    ...
    function update($id = null)
    {
        ...
        if ($_POST['saveType']=='save-list')
           redirect(site_url("/{$this->ViewPath}/all/"));
            
        else if ($_POST['saveType']=='save')
           redirect(site_url("/{$this->ViewPath}/form/{$t->id}"));
           
        else if ($_POST['saveType']=='save-new')
           redirect(site_url("/{$this->ViewPath}/form/"));   
